...
$pageTitle = 'Players · My Club Hub Portal';
          ...
          <section class="mx-auto max-w-6xl px-6 py-10">
                    <div class="grid gap-6 xl:grid-cols-3">
                              <div class="xl:col-span-2 rounded-3xl border border-white/5 bg-slate-900/70 p-6 shadow-maroon-lg">
                                        <h2 class="text-lg font-semibold text-cream">Squad overview</h2>
                                        ...
                                        <div class="mt-6 rounded-2xl border border-dashed border-white/10 p-8 text-slate-300">
                                                  Player management screens will appear here (add/edit players, positions, eligibility, availability).
                                        </div>
                              </div>
